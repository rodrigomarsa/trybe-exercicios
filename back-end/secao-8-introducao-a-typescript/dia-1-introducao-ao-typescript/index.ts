const readline6 = require('readline-sync'); // importamos o pacote readline-sync
...
const choice = readline6.keyInSelect(scriptNames, "Escolha um número para executar o script de conversão de unidade");
